...
public class ConsumerService {
	...
	private Consumer<String, RdfTransaction> kafkaConsumer;
	...
	public ConsumerService() {
		...
		Consumer<String, RdfTransaction> cons = new KafkaConsumer<>(props);
		this.kafkaConsumer = cons;
	}

	public Consumer<String, RdfTransaction> getInstance() {
		this.kafkaConsumer.subscribe(Collections.singletonList(IKafkaConstants.TOPIC_NAME));
